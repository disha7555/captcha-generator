...
{
    let generatedText="";
    //String.fromCharCode gives ASCII value from given number
    //total 9 letters hence loop of 3 with 3 types of randomly generated things
    for(let i=0;i<3;i++){
        //65-90:for capital letters
        generatedText+=String.fromCharCode(randomNumber(65,90));
         //97-122:for small letters
         generatedText+=String.fromCharCode(randomNumber(97,122));
          //48-57:for numbers from 0-9
